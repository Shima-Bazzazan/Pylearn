...
class MainWindow(QMainWindow):
    ...
    def read_data(self , alarms):
        ...
        for i in range(len(alarms)) :
            ...
            space = QLabel() 
            space.setText("")  
            new_checkbox.setStyleSheet(u"color: rgb(0, 0, 0);\n""background-color: qlineargradient(spread:pad, x1:0.52, y1:1, x2:0.531421, y2:0.318, stop:0 rgba(0, 0, 0, 0), stop:1 rgba(0, 0, 0, 0) );")
            alarm_title.setStyleSheet(u"color: rgb(0, 0, 0);\n""background-color: qlineargradient(spread:pad, x1:0.52, y1:1, x2:0.531421, y2:0.318, stop:0 rgba(0, 0, 0, 0), stop:1 rgba(0, 0, 0, 0) );")
            alarm_time.setStyleSheet(u"color: rgb(0, 0, 0);\n""background-color: qlineargradient(spread:pad, x1:0.52, y1:1, x2:0.531421, y2:0.318, stop:0 rgba(0, 0, 0, 0), stop:1 rgba(0, 0, 0, 0) );")
            alarm_date.setStyleSheet(u"color: rgb(0, 0, 0);\n""background-color: qlineargradient(spread:pad, x1:0.52, y1:1, x2:0.531421, y2:0.318, stop:0 rgba(0, 0, 0, 0), stop:1 rgba(0, 0, 0, 0) );")
            font2 = QFont()
            font2.setFamily(u"Dosis ExtraBold")
            font2.setPointSize(12)
            font3 = QFont()
            font3.setFamily(u"Dosis ExtraBold")
